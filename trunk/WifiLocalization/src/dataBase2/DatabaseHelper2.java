...
public class DatabaseHelper2 extends SQLiteOpenHelper {
	...
	public void inserisciDatiWifi(float x, float y, int id_rp, String ssid,
			...
			double c52, double c50, double c48, double c46, double c44,
			double c42, double c40, double c38, double c36, double c34,
			double c32, double c30, double c28, double c26, double c24,
			double c22) {
